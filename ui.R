           ...
           tabPanel("Données",
                    fluidRow(
                      ...
                      column(6,wellPanel(
                        ...
                        numericInput("min.prior","Nombre minimal d'aloses, a priori",value=5),
                        numericInput("max.prior","Nombre maximal d'aloses, a priori",value=688)
                      ))
           ...
           tabPanel("Paramètres",
                    ...
                    fluidRow(
                      ...
                      column(4,wellPanel(
                        ...
                        hr(),
                        numericInput ("intercept.thermie", "Ordonnée à l'origine de la relation entre température et probabilité d'occurrence d'au moins un bull",value=-4.8623,step=0.5),
